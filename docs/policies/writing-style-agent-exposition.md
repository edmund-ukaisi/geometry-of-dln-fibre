# Writing style: agent exposition

How we write reader-facing markdown that explains agent work: expositions,
theory notes, claim discussion, and synthesis. The target renderer is the
**scholium** viewer (pymdownx markdown). This policy is expected to evolve;
