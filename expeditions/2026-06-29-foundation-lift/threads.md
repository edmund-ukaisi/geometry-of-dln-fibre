...
| 07 | lean-formaliser (P2-R2, **CRUX**) | extract matrix minor-rank core (`rank_le_iff_forall_submatrix_det_eq_zero` + `rank_map_eq_of_injective`) → `Core/.../Matrix/RankMinors` | **in flight** (branch `-p2`) |
