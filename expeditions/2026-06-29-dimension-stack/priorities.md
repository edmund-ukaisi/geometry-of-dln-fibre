...
| R1 | integral-extension dimension invariance (`ringKrullDim_eq_of_integral_injective` + going-up chain-lift) | `IntegralDimension` | `Core.Dimension.Integral` (+ `Dimension.Basic`) | **done** (`f447c0ce`; reviewed PASS; re-gate in flight) |
