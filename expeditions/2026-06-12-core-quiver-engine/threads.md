...
| 10-barcode | formalisation (teammate `barcode`) | review-pending | **4d COMPLETE — abstract-chain existence MERGED** (`Core.Barcode`, 722 lines, green/axiom-clean): `hasBarcode_of_isSubrep`/`hasBarcode_top` = existence half of type-A Gabriel. Full stack sorry-free; controller-precision-checked. `barcode/rung-4d` on origin. |
