...
| 15-cor29-audit | review (`reviewer5`) | in-progress | Decorrelated audit of the new `Core.Gabriel` (Prop 3.1b + uniqueness) + `Core.Orbit` (complete invariant + normal form) content. Gates the capstone. |
