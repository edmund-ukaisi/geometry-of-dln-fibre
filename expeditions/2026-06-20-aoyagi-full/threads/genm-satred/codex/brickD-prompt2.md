<constraints>Do NOT run any shell commands, file reads, or tools. The problem below is FULLY SPECIFIED — answer from mathematical reasoning ALONE. Any attempt to explore a filesystem will fail (read-only exec, no approval).</constraints>
