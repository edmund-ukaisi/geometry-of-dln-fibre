...
>   (`lean/DLNFibre/DLN/RLCT/Validate/D1SecondPeelChart.lean` @ canonical `expedition/aoyagi-full` `51f34643`)
>   and `DLNFibre.DLN.RLCT.deepest_le_of_optimal_secondPeel_discharged`
>   (`lean/DLNFibre/DLN/RLCT/Validate/D1SecondPeelAssembly.lean` @ canonical `expedition/aoyagi-full` `51f34643`)
