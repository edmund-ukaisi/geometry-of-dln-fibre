...
| **RHS≠0 + uzero** (helper) | aa56113 | genm-sj5-pivotdom → @4746bd2c | ★ DONE — pivotDom_RHS_ne_zero (@58568ab8) + pivotDom_uzero (@4746bd2c) both axiom-clean (forced #print axioms), pushed. RouteMSJPivotDom's only remaining sorry = pivotDom_finiteness (tide-b). Reviewer ac0ad4c0 spawned (independent fidelity). Helper now on L=1 scope-first (fresh branch off expedition). |
