...
**UPDATE-78 (2026-06-25) — h1 breakthrough banked (cast cleared, general-L); h2 frame finding: exact hCore is FALSE under frames → bridge needs an O(Sreg)-relaxed sibling (pp adjudicating). HEAD 440bbbf8.**
