...
**L2 bridge:** real Ψ + S3 + lens-decomposition + the S4 toolkit (incl. W⁻¹-1 crack @5d3184a6) banked; S4 = mechanical assembly → `genm-l2cle` (gated); S6 a later tide. **D1** on the bridge. Aggregation pre-staged (#143).
