# Statement card - A6 Theorem 2 active-ratio terminal-order bridge
...
The second terminal-label equality is the existing A5 terminal-order bridge.
...
correctness, active-ratio inequalities from the blow-up recursion,
chart-order/terminal-label identification, source-backed Lemma 5 no-extra
coverage, source-backed branch-label injectivity, source-backed terminal upper
bound, pole order without A0, and RLCT extraction.
