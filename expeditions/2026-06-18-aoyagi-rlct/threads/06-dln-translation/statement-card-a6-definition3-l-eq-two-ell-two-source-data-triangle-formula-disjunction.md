# Statement Card - A6 `L=2`, `ell=2` Triangle Formula Disjunction

Date: 2026-07-02.

## Claim

For supplied `L=2`, `ell=2` Definition 3 source data, the finite Theorem 2
formula dispatch lands in the odd/even triangle branch disjunction, not the
general repeated-positive-or-triangle branch disjunction.

## Source Status

Aoyagi Definition 3 on PDF pp. 8-9 supplies the finite source-data
inequalities.  The proof uses the extracted fixed-`ell=2` classifier and the
already-formalized odd/even triangle formula packages.
