...
> - **Cited.** None.
> - **Deferred.** Iterating this step through all paper layers; proving that
>   the chosen edge matrices compose with the endpoint total-product matrix;
>   rank-stratum statements; topological open-neighborhood statements; target
>   normalization; and every analytic/RLCT consequence.
