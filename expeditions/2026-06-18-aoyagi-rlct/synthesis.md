...
This is only product-difference block algebra.  The endpoint wrapper is
intentionally deferred until a downstream ideal/certificate theorem needs the
exact `T - T0` form; no regular-suspension, pole-order, or RLCT shift is
claimed.
