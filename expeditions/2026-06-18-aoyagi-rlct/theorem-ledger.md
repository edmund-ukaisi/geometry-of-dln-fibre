...
| Theorem 2 multi-layer main formula | A6 | PDF pp. 8-9 | A0-A5 | formula arithmetic reproduced at `threads/06-dln-translation/reproduction-definition3-theorem2-translation-a6.md`; final theorem still open | final theorem TBD; formula notation/equivalences proved in `lean/DLNFibre/DLN/Aoyagi/FinalFormula.lean` | formula slice reviewed at `threads/06-dln-translation/review-final-formula-notation-a6.md`; final theorem review pending |
...
| Notation translation to repo DLN dimensions | A6 | Aoyagi PDF pp. 8-9 | source inventory; selected cutpoint API | reproduced at `threads/06-dln-translation/reproduction-definition3-theorem2-translation-a6.md`; source/API xhigh checks incorporated | `AoyagiDefinition3CeilData`, `theorem2OrderFormula`, `aoyagiTheorem2Lambda_average`, `aoyagiTheorem2Lambda_ceil`, `aoyagiTheorem2Lambda_expanded`, `selectedWidthAverage_eq_ceil`, `aoyagiTheorem2Lambda_average_eq_fromCeilData`, and `aoyagiTheorem2Lambda_average_eq_expanded_ofCeilData` proved in `lean/DLNFibre/DLN/Aoyagi/FinalFormula.lean` | reviewed at `threads/06-dln-translation/review-final-formula-notation-a6.md`; statement card `threads/06-dln-translation/statement-card-a6-final-formula-notation.md` |
| Definition 3 selected-sum bridge | A6 | Aoyagi PDF pp. 8-9 and pp. 24-25 | A6 notation; Lemma 4/Htilde arithmetic | reproduced at `threads/06-dln-translation/reproduction-definition3-lemma4-bridge-a6.md`; xhigh source check incorporated | `AoyagiDefinition3CeilData.one_le_ell`, `one_le_aParam`, `terminalEndpoint_eq_zero`, `htildeLowerChain_last_eq_zero`, `htildeUpperChain_last_eq_zero`, `htildeLowerNat_last_eq_zero`, `htildeUpperNat_last_eq_zero`, `htildeUpperNat_pred_eq_sub_lastWidth`, `Hlast_eq_zero_of_htildeChainBounds`, `selectedWidth_le_pred_of_sourceSelectedInequality`, `htildeLowerNat_add_one_labelBounds_of_sourceSelectedInequality`, and `lemma5Eq5_labelBounds_of_sourceSelectedInequality` proved in `lean/DLNFibre/DLN/Aoyagi/Definition3Bridge.lean` | reviewed at `threads/06-dln-translation/review-definition3-bridge-a6.md`; statement card `threads/06-dln-translation/statement-card-a6-definition3-bridge.md` |
