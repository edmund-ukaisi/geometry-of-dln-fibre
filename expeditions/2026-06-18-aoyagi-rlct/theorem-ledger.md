...
|---|---|---|---|---|---|---|
| RLCT definition and normal-crossing extraction | A0 | PDF pp. 5-6 | external analytic theorem | cite-interface check pending | interface TBD; open/Cited | pending |
