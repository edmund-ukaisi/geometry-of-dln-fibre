...
|---|---|---|---|---|---|---|
| RLCT definition and normal-crossing extraction | A0 | PDF pp. 5-6 | external analytic theorem | scout report `threads/02-analytic-interface/scout-report.md`; interface draft `threads/02-analytic-interface/interface-draft.md` | interface TBD after A4 certificate data; open/Cited | draft reviewed by controller; Lean shape pending |
...
| Theorem 3 product reduction | A2 | PDF pp. 11-13 | A1, product/block notation, through-layer open-chart/basis lemma | draft + failed full check plus repair report: `threads/03-block-product-reduction/reproduction-draft.md`, `threads/03-block-product-reduction/reproduction-check.md`, `threads/03-block-product-reduction/reproduction-repair-a2.md`; full theorem not formalisation-ready; chart-local induction step reproduced | partial sub-artifact proved: `productReduction_chartLocalInductionStep_fromBlocks` in `lean/DLNFibre/DLN/Aoyagi/ProductReduction.lean`; full theorem blocked | xhigh hardener and fidelity reviewer pass for chart-local theorem; statement card `threads/03-block-product-reduction/statement-card-a2-chart-local-induction-step.md`; full Theorem 3 review pending |
