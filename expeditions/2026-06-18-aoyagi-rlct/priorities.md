...
1. Review and commit the Eq3 upper away-from-boundary slice.
...
3. Next source-facing target: continue the endpoint inventory around the
   ...
   Eq4's strict guard.  Source-label legality, injection, and back-to-label
   coverage remain unproved.  Do not claim Aoyagi's printed Case 1(2)
   paragraph supplies source coverage or injectivity.
