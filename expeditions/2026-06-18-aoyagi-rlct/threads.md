...
| 03-block-product-reduction | formalisation | in-progress | A1 algebraic block identities and rank formula landed; A2 chart-local induction-step and entry-ideal transport lemmas landed/reviewed; full Theorem 3 still needs through-layer chart and certificate transport. |
