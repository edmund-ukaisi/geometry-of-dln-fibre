...
| 03-block-product-reduction | formalisation | in-progress | A1 algebraic block identities and rank formula landed; A2 chart-local induction-step, entry-ideal transport, through-subspace, and per-edge transported matrix block lemmas landed; full Theorem 3 still needs complement/direct-sum packaging, chain assembly, and certificate transport. |
