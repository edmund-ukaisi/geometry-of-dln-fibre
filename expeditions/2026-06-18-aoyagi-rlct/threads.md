...
| 03-block-product-reduction | formalisation | in-progress | A1 algebraic block identities and rank formula landed; A2 chart-local induction-step, entry-ideal transport, through-subspace, per-edge transported matrix blocks, and endpoint total-product block landed; full Theorem 3 still needs intermediate chain assembly and certificate transport. |
