...
| 02-analytic-interface | explore/formalisation | closed | Interface draft saved; A2 repair keeps A0 extraction-only and excludes Lemma 1/additivity/Theorem 4 as separate citations. Finite exponent interface `NormalCrossingInterface.lean` now proves active-ratio minimum/order arithmetic and exposes `AoyagiNormalCrossingExtractionHypothesis`; reopen later only for actual chart-certificate data. |
...
| 06-dln-translation | formalisation | in-progress | Formula notation, dimension/rank convention bridge, Definition 3 bridge, and conditional A0/A6 finite-exponent bridge landed without quiver inputs; final theorem still blocked on A4/A5 normal-crossing certificate and finite exponent equalities. |
