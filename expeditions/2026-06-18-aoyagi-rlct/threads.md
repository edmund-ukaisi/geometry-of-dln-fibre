...
| 04-blow-up-certificate | pen-and-paper/formalisation | blocked | xhigh scout `Ptolemy` returned and checker `Copernicus` reviewed. Draft has a width-notation source-fidelity error and unresolved chart/regularity/termination gaps; this is the next repair target after A2 boundary packaging. |
