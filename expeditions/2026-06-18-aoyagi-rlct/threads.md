...
| 03-block-product-reduction | formalisation | blocked | A1 algebraic block identities and rank formula landed with xhigh worker `Lovelace` and reviewer `Euclid`; A2 remains blocked pending statement/reproduction repair. |
