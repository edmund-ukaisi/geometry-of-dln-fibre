...
-- maxHeartbeats bumped: the 27-coordinate triangular recovery is an elaboration-heavy per-axis case split.
set_option maxHeartbeats 1600000 in
...
-- maxHeartbeats bumped: the 4-axis Jacobian change-of-variables with null-slice add-back is elaboration-heavy.
set_option maxHeartbeats 1600000 in
