...
/-- **FINAL — the L=2 diffeo bridge** (the content of `deepest_diffeo_bridge_L2`). Signature matches
`DeepestGaugeConstruction.lean:2853` verbatim; the controller `exact`s this into the 2915 site.
