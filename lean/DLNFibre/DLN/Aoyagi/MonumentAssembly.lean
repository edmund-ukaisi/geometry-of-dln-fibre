...
retired at the summit. The residual `sorryAx` cone is the still-sorried `MonumentAtlas` L5/L7/L1
— the primed footprint-sources are the baked-driver sources MINUS L6 + L8.
-/
