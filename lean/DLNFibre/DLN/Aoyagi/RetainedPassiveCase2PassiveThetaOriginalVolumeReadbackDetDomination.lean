...
set_option linter.style.longLine false in
set_option maxHeartbeats 900000 in
-- This consumes the source-cylinder raw-patch handoff at the formal-product interface.
/-- Localized formal-product domination from source-cylinder chart-piece
support and a lower source-density bound.

This is the formal-product consumer of
...
The source-cylinder support hypothesis is kept at the public boundary; p.13
source-set support is derived internally from the local source-chart image
theorem.

This theorem does not prove determinant-chart Haar transport, exact raw-Haar
...
or RLCT extraction. -/
theorem exists_open_subset_formalProductMeasure_restrict_chartPiece_le_smul_coordinateSourceReference_of_chartPiece_subset_sourceChart_image_inter_sourceCylinder_sourceDensity_lower
    (W₂ : Fin 3 → Type v) [∀ i, AddCommGroup (W₂ i)]
    [∀ i, TopologicalSpace (W₂ i)] [∀ i, IsTopologicalAddGroup (W₂ i)]
    [∀ i, T2Space (W₂ i)] [∀ i, Module ℝ (W₂ i)]
    [∀ i, ContinuousSMul ℝ (W₂ i)]
  ...
  intro Θ RawTuple EdgeFamily Y referenceSource jacobianDensity baseJ
    ...
    rawSourceSet rawChart p13SourceSet pivotNext signedBox sourceCylinder
  rcases
      (by
        simpa [RawTuple, EdgeFamily, sourceChart, rawMap, rawSourceSet,
          p13SourceSet, rawChart] using
  ...
  rcases
      (by
        simpa [Θ, EdgeFamily, sourceChart, p13SourceSet] using
          exists_open_subset_measurableSet_case2PassiveThetaWithFollowingFactorEndpointSourceChart_image_subset_p13SourceEdgeFamilySet
            W₂ B₂ n hS hcont hnext (U₀ := U₀) (hU₀ := hU₀) eNext e
            z₀ hdet₀ hpivot₀ Vformal hVformalopen hz₀Vformal) with
    ⟨Vsource, hVsourceopen, hz₀Vsource, hVsource_formal,
      _hdet_source, _hleft_source, _hsource_inj, _hsource_contOn,
      _hsource_image_meas, _hpoint_p13, himage_p13⟩
  rcases
      (by
        simpa [Θ, RawTuple, Y, referenceSource, jacobianDensity, baseJ,
          EdgeFamily, sourceChart, sourceDensity, coordinateSourceMeasure,
          rawMap, rawDetChart, rawSourceSet, rawChart, p13SourceSet,
          pivotNext, signedBox, sourceCylinder] using
          exists_open_subset_rawHaar_restrict_patch_le_smul_measure_map_case2PassiveThetaWithFollowingFactor_rawMap_coordinateSourceMeasure_restrict_of_chartPiece_subset_sourceChart_image_inter_sourceCylinder_sourceDensity_lower
            W₂ B₂ n hS hcont hnext (U₀ := U₀) (hU₀ := hU₀) eNext e
            z₀ hdet₀ hpivot₀ sourceImageDensity Rres Vsource
            hVsourceopen hz₀Vsource) with
    ⟨V, hVopen, hz₀V, hV_source, hraw_package⟩
  have hV_formal : V ⊆ Vformal := fun z hz ↦ hVsource_formal (hV_source hz)
  ...
  have himage_p13V : ∀ E ∈ sourceChart '' V, E ∈ p13SourceSet := by
    ...
    simpa [sourceChart, p13SourceSet,
      ...
      himage_p13 (sourceChart z) z.1.A1passive z.1.F2 z.1.A3passive
        z.1.Ctop z.1.F3 z.1.yNext z.2 (hV_source hzV) rfl
  have hchartPiece_sub_p13 : chartPiece ⊆ p13SourceSet := by
    intro E hE
    rcases hchartPiece_sub_cylinder hE with ⟨z, hz, rfl⟩
    exact himage_p13V (sourceChart z) ⟨z, hz.1, rfl⟩
  rcases
      hraw_package rawHaar chartPiece hchartPiece hchartPiece_sub_cylinder
  ...
  have hraw_dom_bridge :
    ...
    simpa [P, Ddet, RawTuple, rawMap, coordinateSourceMeasure,
        ...
        (fun z : RawTuple ↦
          ENNReal.ofReal
            (retainedPassiveFormalRawOrderJacobianProductAbsDetAt
              ...
              (κ' := throughSubspaceEndpointComplementIndex
                (reverseVertex W₂) (reverseEdge W₂ B₂) U₀) z)))
  let sourceRef := Measure.map sourceChart (coordinateSourceMeasure.restrict V)
  have hformal_piece :
    ...
    simpa [RawTuple, EdgeFamily, sourceChart, rawMap, rawDetChart,
      ...
      formalProductMeasure, sourceRef, Ddet, P, hrestrict_formal] using
      hformal_dom (coordinateSourceMeasure.restrict V) rawHaar chartPiece
        P (D := Ddet) hchartPiece hchartPiece_sub_p13 hP_sub
        hrawPatch_sub hraw_dom_bridge
  exact ⟨hDfinite, hformal_piece⟩
...
set_option linter.style.longLine false in
set_option maxHeartbeats 900000 in
-- This consumes the source-cylinder formal-product handoff at the p.13
-- original-volume interface.
/-- Localized original-volume domination from source-cylinder chart-piece
support and a lower source-density bound.
...
with the p.13 inverse-Haar original-volume bridge.  The source-cylinder
support hypothesis is kept at the public boundary; p.13 source-set support is
derived internally from the local source-chart image theorem.

This theorem does not prove determinant-chart Haar transport, exact raw-Haar
pushforward, Haar normalization, source-density positivity, source coverage,
source-rank coverage, original-prior transport, readback domination, normal
crossings, pole order, or RLCT extraction. -/
theorem exists_open_subset_originalEdgeFamilyVolume_restrict_chartPiece_le_smul_coordinateSourceReference_of_chartPiece_subset_sourceChart_image_inter_sourceCylinder_sourceDensity_lower
    (W₂ : Fin 3 → Type v) [∀ i, AddCommGroup (W₂ i)]
    [∀ i, TopologicalSpace (W₂ i)] [∀ i, IsTopologicalAddGroup (W₂ i)]
    [∀ i, T2Space (W₂ i)] [∀ i, Module ℝ (W₂ i)]
    [∀ i, ContinuousSMul ℝ (W₂ i)]
      ...
      (by
        simpa [Θ, EdgeFamily, sourceChart, p13SourceSet] using
          exists_open_subset_measurableSet_case2PassiveThetaWithFollowingFactorEndpointSourceChart_image_subset_p13SourceEdgeFamilySet
            W₂ B₂ n hS hcont hnext (U₀ := U₀) (hU₀ := hU₀) eNext e
            z₀ hdet₀ hpivot₀ G hGopen hz₀G) with
    ⟨Vsource, hVsourceopen, hz₀Vsource, hVsourceG,
      _hdet_source, _hleft_source, _hsource_inj, _hsource_contOn,
      _hsource_image_meas, _hpoint_p13, himage_p13⟩
  rcases
      (by
        simpa [Θ, RawTuple, Y, referenceSource, jacobianDensity, baseJ,
          ...
          exists_open_subset_formalProductMeasure_restrict_chartPiece_le_smul_coordinateSourceReference_of_chartPiece_subset_sourceChart_image_inter_sourceCylinder_sourceDensity_lower
            ...
            z₀ hdet₀ hpivot₀ sourceImageDensity Rres Vsource
            hVsourceopen hz₀Vsource) with
    ⟨V, hVopen, hz₀V, hV_source, hformal_package⟩
  have hVG : V ⊆ G := fun z hz ↦ hVsourceG (hV_source hz)
  refine ⟨V, hVopen, hz₀V, hVG, ?_⟩
  intro rawHaar _instRawHaar chartPiece ε hchartPiece
    hchartPiece_sub_cylinder hsource_lower hε_ne_zero hε_ne_top
  have hchartPiece_sub_p13 : chartPiece ⊆ p13SourceSet := by
    ...
    simpa [sourceChart, p13SourceSet,
      ...
      Case2PassiveTheta.F3, Case2PassiveTheta.yNext] using
      himage_p13 (sourceChart z) z.1.A1passive z.1.F2 z.1.A3passive
        z.1.Ctop z.1.F3 z.1.yNext z.2 (hV_source hz.1) rfl
  rcases
      hformal_package rawHaar chartPiece hchartPiece hchartPiece_sub_cylinder
        hsource_lower hε_ne_zero hε_ne_top with
    ⟨Cdet, hCdet, hDfinite, hformal_piece⟩
  let Ddet := Cdet * ε⁻¹
  refine ⟨Cdet, hCdet, ?_⟩
  dsimp only
  let formalProductMeasure : Measure EdgeFamily :=
  ...
  have hformal_piece' :
    ...
    simpa [RawTuple, EdgeFamily, sourceChart, rawMap, rawDetChart,
      rawSourceSet, p13SourceSet, rawChart, coordinateSourceMeasure,
      formalProductMeasure, sourceRef, Ddet] using hformal_piece
  let cHaar :=
    originalTupleVolumeHaarScalarOfMap d
      (paperEndpointFixedBaseRawOrderMatrixTupleContinuousLinearEquiv
        W₂ B₂ U₀) rawHaar
  ...
  have horiginal :
    ...
    simpa [RawTuple, EdgeFamily, rawDetChart, p13SourceSet, rawChart,
      ...
      originalEdgeFamilyVolume_restrict_chartPiece_le_smul_sourceMeasure_of_map_paperEndpointFixedBaseRetainedPassiveP13RawOrderSourceChart_withDensity_formalProductAbsDet_restrict_chartPiece_le_smul_sourceMeasure
        (W := W₂) (B := B₂) (M := 1) (U₀ := U₀) (hU₀ := hU₀)
        rawHaar hchartPiece hchartPiece_sub_p13 (sourceRef := sourceRef)
        (D := Ddet) hformal_piece'
  have hDvol : Dvol < ∞ := by
    dsimp [Dvol]
    exact ENNReal.mul_lt_top (by simp) hDfinite
...
set_option linter.style.longLine false in
set_option maxHeartbeats 900000 in
-- This direct non-readback wrapper obtains source-cylinder support from C-one signed-box support.
/-- Localized direct original-volume domination from C-one readout support.

The caller supplies ordinary local chart-piece support
`chartPiece ⊆ sourceChart '' V` and the pointwise signed-box condition
`cOneReadout E ∈ signedBox` on the chart piece.  The proof first shrinks to a
local source-chart left inverse, then runs the direct source-cylinder
original-volume domination inside that shrink.  The left inverse converts the
C-one support into the source-cylinder support required by
...
This is still a direct non-readback measure domination.  It does not prove the
C-one signed-box condition for arbitrary chart pieces, source-density
...
theorem exists_open_subset_originalEdgeFamilyVolume_restrict_chartPiece_le_smul_coordinateSourceReference_of_chartPiece_subset_sourceChart_image_cOneReadout_mem_signedBox_sourceDensity_lower
    (W₂ : Fin 3 → Type v) [∀ i, AddCommGroup (W₂ i)]
    [∀ i, TopologicalSpace (W₂ i)] [∀ i, IsTopologicalAddGroup (W₂ i)]
    [∀ i, T2Space (W₂ i)] [∀ i, Module ℝ (W₂ i)]
    [∀ i, ContinuousSMul ℝ (W₂ i)]
  ...
  intro Θ RawTuple EdgeFamily Y referenceSource jacobianDensity baseJ
    ...
    rawMap rawDetChart rawSourceSet rawChart p13SourceSet pivotNext signedBox
    sourceCylinder d originalVolume
  rcases
      (by
        simpa [Θ, EdgeFamily, sourceChart, readback, p13SourceSet] using
          exists_open_subset_measurableSet_case2PassiveThetaWithFollowingFactorEndpointSourceChart_image_subset_p13SourceEdgeFamilySet
            W₂ B₂ n hS hcont hnext (U₀ := U₀) (hU₀ := hU₀) eNext e
            z₀ hdet₀ hpivot₀ G hGopen hz₀G) with
    ⟨W, hWopen, hz₀W, hWG, _hdetW, hleftW, hsource_injW,
      hsource_contOnW, _hsource_imageW, _hpoint_p13W, himage_p13W⟩
  rcases
      (by
        simpa [Θ, RawTuple, EdgeFamily, Y, referenceSource, jacobianDensity,
          baseJ, sourceChart, sourceDensity, coordinateSourceMeasure, rawMap,
          rawDetChart, rawSourceSet, rawChart, p13SourceSet, pivotNext,
          signedBox, sourceCylinder, d, originalVolume] using
          exists_open_subset_originalEdgeFamilyVolume_restrict_chartPiece_le_smul_coordinateSourceReference_of_chartPiece_subset_sourceChart_image_inter_sourceCylinder_sourceDensity_lower
            W₂ B₂ n hS hcont hnext (U₀ := U₀) (hU₀ := hU₀) eNext e
            z₀ hdet₀ hpivot₀ sourceImageDensity Rres W hWopen hz₀W) with
    ⟨V, hVopen, hz₀V, hVW, hvolume_package⟩
  ...
  have himage_p13V : ∀ E ∈ sourceChart '' V, E ∈ p13SourceSet := by
    ...
    simpa [sourceChart, p13SourceSet,
      ...
      Case2PassiveTheta.A3passive, Case2PassiveTheta.Ctop,
      Case2PassiveTheta.F3, Case2PassiveTheta.yNext] using
      himage_p13W (sourceChart z) z.1.A1passive z.1.F2 z.1.A3passive
        z.1.Ctop z.1.F3 z.1.yNext z.2 (hVW hzV) rfl
...
set_option linter.style.longLine false in
set_option maxHeartbeats 900000 in
-- This adds the bounded original-prior density handoff to the direct
-- source-cylinder original-volume domination.
/-- Localized original-prior domination from source-cylinder chart-piece
support, a lower source-density bound, and a local upper bound for the original
prior density.

This composes
`exists_open_subset_originalEdgeFamilyVolume_restrict_chartPiece_le_smul_coordinateSourceReference_of_chartPiece_subset_sourceChart_image_inter_sourceCylinder_sourceDensity_lower`
with the bounded-density comparison
`originalEdgeFamilyPrior_restrict_le_smul_of_ae_le`.  It is a direct
non-readback measure domination; it does not identify the original prior with
the chart-produced coordinate source.
...
theorem exists_open_subset_originalEdgeFamilyPrior_restrict_chartPiece_le_smul_coordinateSourceReference_of_chartPiece_subset_sourceChart_image_inter_sourceCylinder_sourceDensity_lower_priorDensity_upper
    (W₂ : Fin 3 → Type v) [∀ i, AddCommGroup (W₂ i)]
    [∀ i, TopologicalSpace (W₂ i)] [∀ i, IsTopologicalAddGroup (W₂ i)]
    [∀ i, T2Space (W₂ i)] [∀ i, Module ℝ (W₂ i)]
    [∀ i, ContinuousSMul ℝ (W₂ i)]
                          ...
                          Cdet < ∞ ∧
                            ...
                            Cprior < ∞ ∧
                              (originalEdgeFamilyPrior (V := reverseVertex W₂)
                                (paperEndpointFixedBaseFinBasis W₂ B₂ U₀ hU₀)
                                density).restrict chartPiece ≤ Cprior • sourceRef := by
  intro Θ RawTuple EdgeFamily Y referenceSource jacobianDensity baseJ
    sourceChart sourceDensity coordinateSourceMeasure rawMap rawDetChart
    rawSourceSet rawChart p13SourceSet pivotNext signedBox sourceCylinder
    d originalVolume
  rcases
      (by
        simpa [Θ, RawTuple, Y, referenceSource, jacobianDensity, baseJ,
          EdgeFamily, sourceChart, sourceDensity, coordinateSourceMeasure,
          rawMap, rawDetChart, rawSourceSet, rawChart, p13SourceSet,
          pivotNext, signedBox, sourceCylinder, d, originalVolume] using
          exists_open_subset_originalEdgeFamilyVolume_restrict_chartPiece_le_smul_coordinateSourceReference_of_chartPiece_subset_sourceChart_image_inter_sourceCylinder_sourceDensity_lower
            W₂ B₂ n hS hcont hnext (U₀ := U₀) (hU₀ := hU₀) eNext e
            z₀ hdet₀ hpivot₀ sourceImageDensity Rres G hGopen hz₀G) with
    ⟨V, hVopen, hz₀V, hVG, hvolume_package⟩
  refine ⟨V, hVopen, hz₀V, hVG, ?_⟩
  intro rawHaar _instRawHaar chartPiece ε hchartPiece
    hchartPiece_sub_cylinder hsource_lower hε_ne_zero hε_ne_top density
    Kprior hdensity
  rcases
      hvolume_package rawHaar chartPiece (ε := ε) hchartPiece
        hchartPiece_sub_cylinder hsource_lower hε_ne_zero hε_ne_top with
    ⟨Cdet, hCdet, hDvol, hvolume_dom⟩
  let Ddet := Cdet * ε⁻¹
  let cHaar :=
    originalTupleVolumeHaarScalarOfMap d
      (paperEndpointFixedBaseRawOrderMatrixTupleContinuousLinearEquiv
  ...
  have hprior_dom :
      (originalEdgeFamilyPrior (V := reverseVertex W₂)
        (paperEndpointFixedBaseFinBasis W₂ B₂ U₀ hU₀)
        density).restrict chartPiece ≤ Cprior • sourceRef := by
    simpa [originalEdgeFamilyPrior, originalVolume, Ddet, cHaar, Dvol,
      Cprior, sourceRef] using
      restrict_withDensity_ofReal_le_smul_of_restrict_le_smul_of_ae_le
        (μ := originalVolume) (ν := sourceRef) (density := density)
        (s := chartPiece) (K := Kprior) (c := Dvol) hchartPiece
        (by simpa [Ddet, cHaar, Dvol, sourceRef] using hvolume_dom)
        hdensity
  have hCprior : Cprior < ∞ := by
    dsimp [Cprior]
    exact ENNReal.mul_lt_top ENNReal.ofReal_lt_top (by simpa [Dvol] using hDvol)
  refine ⟨Cdet, hCdet, ?_⟩
  exact ⟨hCprior, by simpa [Cprior, sourceRef] using hprior_dom⟩
...
set_option maxHeartbeats 900000 in
-- This direct non-readback wrapper obtains source-cylinder support from C-one signed-box support.
/-- Localized direct original-prior domination from C-one readout support.

The caller supplies ordinary local chart-piece support
`chartPiece ⊆ sourceChart '' V` and the pointwise signed-box condition
`cOneReadout E ∈ signedBox` on the chart piece.  The proof first shrinks to a
local source-chart left inverse, then runs the direct source-cylinder prior
domination inside that shrink.  The left inverse converts the C-one support
into the source-cylinder support required by
...
original-prior transport, readback domination, finite-integral transfer,
normal crossings, pole order, or RLCT extraction. -/
theorem exists_open_subset_originalEdgeFamilyPrior_restrict_chartPiece_le_smul_coordinateSourceReference_of_chartPiece_subset_sourceChart_image_cOneReadout_mem_signedBox_sourceDensity_lower_priorDensity_upper
    (W₂ : Fin 3 → Type v) [∀ i, AddCommGroup (W₂ i)]
    [∀ i, TopologicalSpace (W₂ i)] [∀ i, IsTopologicalAddGroup (W₂ i)]
    [∀ i, T2Space (W₂ i)] [∀ i, Module ℝ (W₂ i)]
    [∀ i, ContinuousSMul ℝ (W₂ i)]
      ...
      (by
        simpa [Θ, RawTuple, EdgeFamily, Y, referenceSource, jacobianDensity,
          ...
          exists_open_subset_originalEdgeFamilyPrior_restrict_chartPiece_le_smul_coordinateSourceReference_of_chartPiece_subset_sourceChart_image_inter_sourceCylinder_sourceDensity_lower_priorDensity_upper
            W₂ B₂ n hS hcont hnext (U₀ := U₀) (hU₀ := hU₀) eNext e
            z₀ hdet₀ hpivot₀ sourceImageDensity Rres W hWopen hz₀W) with
    ⟨V, hVopen, hz₀V, hVW, hprior_package⟩
  have hVG : V ⊆ G := fun z hz ↦ hWG (hVW hz)
  have hleftV : ∀ z ∈ V, readback (sourceChart z) = z := by
    intro z hz
    simpa [sourceChart, readback,
  ...
  have hchartPiece_sub_cylinder :
    ...
    simpa [Θ, EdgeFamily, sourceChart, readback, cOneReadout, signedBox,
      ...
      chartPiece_subset_case2PassiveThetaWithFollowingFactorEndpointSourceChart_image_inter_sourceCylinder_of_cOneReadout_mem
        ...
        hleftV hchartPiece_sub_image hcOne_support
  exact
    hprior_package rawHaar chartPiece (ε := ε) hchartPiece
      hchartPiece_sub_cylinder hsource_lower hε_ne_zero hε_ne_top
...
set_option linter.style.longLine false in
set_option maxHeartbeats 900000 in
-- This wrapper shrinks into eventual source/prior density bounds before applying the C-one package.
/-- Direct original-prior C-one domination from eventual pullback density bounds.

The hypotheses fix `ε`, the original-prior density, and `Kprior`, then require
eventual bounds near the basepoint:
`ε ≤ sourceImageDensity (sourceChart z)` and
`density (sourceChart z) ≤ Kprior`.  The proof shrinks into their common
event, applies the direct C-one support theorem there, and turns the pointwise
eventual bounds into the a.e. source-density and prior-density hypotheses
required by that theorem.

This theorem does not prove the C-one signed-box condition for arbitrary chart
pieces, source-density positivity, prior-density boundedness, determinant-chart
Haar transport, exact raw-Haar pushforward, Haar normalization, source coverage,
...
extraction. -/
theorem exists_open_subset_originalEdgeFamilyPrior_restrict_chartPiece_le_smul_coordinateSourceReference_of_chartPiece_subset_sourceChart_image_cOneReadout_mem_signedBox_eventually_sourceImageDensity_comp_sourceChart_lower_priorDensity_comp_sourceChart_upper
    (W₂ : Fin 3 → Type v) [∀ i, AddCommGroup (W₂ i)]
    [∀ i, TopologicalSpace (W₂ i)] [∀ i, IsTopologicalAddGroup (W₂ i)]
    [∀ i, T2Space (W₂ i)] [∀ i, Module ℝ (W₂ i)]
    [∀ i, ContinuousSMul ℝ (W₂ i)]
  ...
  rcases
      (by
        simpa [Θ, RawTuple, EdgeFamily, Y, referenceSource, jacobianDensity,
          baseJ, sourceChart, readback, cOneReadout, sourceDensity,
          coordinateSourceMeasure, rawMap, rawDetChart, rawSourceSet,
          rawChart, p13SourceSet, pivotNext, signedBox, sourceCylinder, d,
          ...
          exists_open_subset_originalEdgeFamilyPrior_restrict_chartPiece_le_smul_coordinateSourceReference_of_chartPiece_subset_sourceChart_image_cOneReadout_mem_signedBox_sourceDensity_lower_priorDensity_upper
            W₂ B₂ n hS hcont hnext (U₀ := U₀) (hU₀ := hU₀) eNext e
            z₀ hdet₀ hpivot₀ sourceImageDensity Rres Gshrink
            hGshrink_open hz₀Gshrink) with
    ⟨V, hVopen, hz₀V, hVGshrink, hleftV, hsource_injV,
      hsource_contOnV, hsource_imageV, himage_p13V, hprior_package⟩
  have hVG : V ⊆ G := fun z hz ↦ (hVGshrink hz).1
  have hVbounds : V ⊆ Gbounds := fun z hz ↦ (hVGshrink hz).2
  have hleftV' : ∀ z ∈ V, readback (sourceChart z) = z := by
    simpa [readback, sourceChart] using hleftV
  have hsource_injV' : Set.InjOn sourceChart V := by
    simpa [sourceChart] using hsource_injV
  have hsource_contOnV' : ContinuousOn sourceChart V := by
    simpa [sourceChart] using hsource_contOnV
  have hsource_imageV' : MeasurableSet (sourceChart '' V) := by
    simpa [sourceChart] using hsource_imageV
  have himage_p13V' : ∀ E ∈ sourceChart '' V, E ∈ p13SourceSet := by
    intro E hE
    rcases hE with ⟨z, hzV, hEz⟩
    rcases z with ⟨⟨⟨A1passive, F2, A3passive, A2passive, F3⟩, center⟩,
      following⟩
    simpa [sourceChart, p13SourceSet] using
      himage_p13V E A1passive F2 A3passive A2passive F3 center following hzV hEz
  refine ⟨V, hVopen, hz₀V, hVG, hleftV', hsource_injV',
    hsource_contOnV', hsource_imageV', himage_p13V', ?_⟩
  intro rawHaar _instRawHaar chartPiece hchartPiece hchartPiece_sub_image
    hcOne_support hε_ne_zero hε_ne_top
  have hsource_image_lower :
      ∀ E ∈ sourceChart '' V, ε ≤ sourceImageDensity E := by
    intro E hE
    rcases hE with ⟨z, hzV, rfl⟩
    exact (hGbounds z (hVbounds hzV)).1
  have hsource_lower :
      ∀ᵐ z ∂baseJ.restrict V, ε ≤ sourceDensity z := by
    simpa [sourceDensity] using
      ae_restrict_comp_lower_of_forall_image_lower
        (μ := baseJ) (V := V) (f := sourceChart) (g := sourceImageDensity)
...
set_option linter.style.longLine false in
set_option maxHeartbeats 900000 in
-- This wrapper derives the eventual C-one density bounds from continuity at the basepoint.
/-- Direct original-prior C-one domination from continuity of the two density pullbacks.

The strict inequalities at `z₀`, together with continuity of the pulled-back
source-image density and original-prior density, produce the eventual bounds
consumed by
...
This theorem still assumes the continuity and strict basepoint inequalities.
It does not prove C-one signed-box support, source-density positivity,
prior-density boundedness without those hypotheses, determinant-chart Haar
transport, exact raw-Haar pushforward, Haar normalization, source coverage,
source-rank coverage, source-prior or original-prior transport, readback
domination, finite-integral transfer, normal crossings, pole order, or RLCT
extraction. -/
theorem exists_open_subset_originalEdgeFamilyPrior_restrict_chartPiece_le_smul_coordinateSourceReference_of_chartPiece_subset_sourceChart_image_cOneReadout_mem_signedBox_of_continuousAt_sourceImageDensity_comp_sourceChart_strict_lower_continuousAt_priorDensity_comp_sourceChart_strict_upper
    (W₂ : Fin 3 → Type v) [∀ i, AddCommGroup (W₂ i)]
    [∀ i, TopologicalSpace (W₂ i)] [∀ i, IsTopologicalAddGroup (W₂ i)]
    [∀ i, T2Space (W₂ i)] [∀ i, Module ℝ (W₂ i)]
    [∀ i, ContinuousSMul ℝ (W₂ i)]
  ...
  have hbounds_eventually :
    ...
    eventually_sourceImageDensity_comp_lower_priorDensity_comp_upper_of_continuousAt
      ...
      (sourceImageDensity := sourceImageDensity)
      (density := density)
      (z₀ := z₀)
      (ε := ε)
      (Kprior := Kprior)
      ...
      (by simpa [sourceChart] using hprior_cont)
      (by simpa [sourceChart] using hprior_lt)
  simpa [Θ, RawTuple, EdgeFamily, Y, referenceSource, jacobianDensity,
    baseJ, sourceChart, readback, cOneReadout, sourceDensity,
    coordinateSourceMeasure, rawMap, rawDetChart, rawSourceSet, rawChart,
    p13SourceSet, pivotNext, signedBox, sourceCylinder, d, originalVolume] using
    exists_open_subset_originalEdgeFamilyPrior_restrict_chartPiece_le_smul_coordinateSourceReference_of_chartPiece_subset_sourceChart_image_cOneReadout_mem_signedBox_eventually_sourceImageDensity_comp_sourceChart_lower_priorDensity_comp_sourceChart_upper
      W₂ B₂ n hS hcont hnext (U₀ := U₀) (hU₀ := hU₀) eNext e
      z₀ hdet₀ hpivot₀ sourceImageDensity Rres
      (ε := ε) (density := density) (Kprior := Kprior)
      hbounds_eventually.1 hbounds_eventually.2 G hGopen hz₀G
