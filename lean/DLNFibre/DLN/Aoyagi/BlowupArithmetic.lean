...
is a supplied-boundary stack identity, not source production of a source-ordered
successor following object, suffix, chart coverage, transition invariant, or
RLCT consequence. -/
