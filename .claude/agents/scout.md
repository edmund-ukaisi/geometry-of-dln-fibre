...
- Output: append to your thread's `thread.md`; write claim cards per `docs/policies/expedition-map.md`.
...
- Stress-test new claims against the kill-condition (degenerate neurons, boundary/closure, edge cases). Established/published results take the light verify-against-source path (`docs/policies/expedition-map.md`).
